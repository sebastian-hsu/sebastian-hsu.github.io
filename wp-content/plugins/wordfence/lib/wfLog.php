...
class wfLog {
	...
	public function initLogRequest() {
		if ($this->currentRequest === null) {
			...
			$this->currentRequest->referer = (isset($_SERVER['HTTP_REFERER']) ? ks_filters($_SERVER['HTTP_REFERER']) : '');
			$this->currentRequest->UA = (isset($_SERVER['HTTP_USER_AGENT']) ? ks_filters($_SERVER['HTTP_USER_AGENT']) : '');
