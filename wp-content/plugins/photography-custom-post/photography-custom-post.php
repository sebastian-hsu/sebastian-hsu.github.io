...
Plugin URI: http://themes.themegoods.com/photography/demo/one
	...
	$labels = array(			  
  	...
  	register_taxonomy(
		...
		array(
			...
			'query_var' => 'eventscat',
			'show_ui' => true,
			'rewrite' => array( 'slug' => 'eventcat', 'with_front' => false ),
		)
	);
...
$postmetas = 
	array (
		...
		'galleries' => array(
			array("section" => "Gallery Template", "id" => "gallery_template", "type" => "select", "title" => "Gallery Template", "description" => "Select gallery template for this gallery", 
				"items" => array(
					...
					"Gallery Striped Wide" => "Gallery Striped Wide",
					...
					"Gallery Mixed Grid Contained" => "Gallery Mixed Grid Contained",
					"Gallery Mixed Grid Wide" => "Gallery Mixed Grid Wide",
		...
		'portfolios' => array(
			...
			array("section" => "Page Menu", "id" => "portfolio_menu_transparent", "type" => "checkbox", "title" => "Make Menu Transparent", "description" => "Check this option if you want to display main menu in transparent on single portfolio page"),
		...
		'team' => array(
		    ...
		    array("section" => "Instagram URL", "id" => "member_instagram", "type" => "text", "title" => "Instagram URL", "description" => "Enter team member Instagram URL"),
		),
