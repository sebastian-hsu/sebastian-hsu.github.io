...
class EXC_MB_Text_Icon extends EXC_MB_Field {
 ...
 ?>
		...
		$(document).ready(function(){
		  $('.wptl-icon-select').iconpicker(".wptl-icon-select");
		  $('.select-ico').on('click',function() {
			  $('.wptl-icon-select').val('');
		  });
		});
		</script>
		<input type="text" class="wptl-icon-select" style=" width:150px" <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr(); ?> <?php $this->name_attr(); ?> value="<?php echo esc_attr( $this->get_value() ); ?>" />
