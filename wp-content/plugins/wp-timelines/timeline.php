...
class WPEX_Timeline{
	...
	function frontend_scripts(){
		...
		wp_register_style('wpex-horiz-css', WPEX_TIMELINE.'css/horiz-style.css');
		...
		ob_end_clean();
		//wp_add_inline_style( 'wpex-timeline-dark-css', $custom_css );freego
		...
		if(is_singular('wp-timeline')){
			//wp_add_inline_style( 'wpex-timeline-css', $custom_css );freego
