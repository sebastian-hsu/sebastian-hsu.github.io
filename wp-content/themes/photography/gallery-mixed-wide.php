...
wp_enqueue_script("photography-script-gallery-metro", admin_url('admin-ajax.php')."?action=photography_script_gallery_metro&id=portfolio_mixed_filter_wrapper&gutter=0", false, THEMEVERSION, true);
?>
