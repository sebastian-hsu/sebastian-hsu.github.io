		    	...
		    	<div class="gallery_archive_info split <?php echo esc_attr($content_class); ?>">
		    		<div class="gallery_archive_info_wrapper">
						...
						<?php
						        ...
						        case 'Image':
						    ?>
						     <a data-rel="photography_portfolio_<?php echo esc_attr($current_page_id); ?>" <?php echo photography_get_portfolio_lightbox_caption_attr(get_the_title()); ?> href="<?php echo esc_url($image_url[0]); ?>" data-thumb="<?php echo esc_url($thumb_url[0]); ?>" class="fancy-gallery button ghost"><?php esc_html_e('View Image', 'photography-translation' ); ?></a>
						...
						<?php
						        ...
						        case 'Vimeo Video':
						    ?>
						    <a data-rel="photography_portfolio_<?php echo esc_attr($current_page_id); ?>" href="https://player.vimeo.com/video/<?php echo esc_attr($portfolio_video_id); ?>?badge=0" <?php echo photography_get_portfolio_lightbox_caption_attr(get_the_title(), $image_url[0]); ?> data-thumb="<?php echo esc_url($thumb_url[0]); ?>" class="lightbox_vimeo button ghost" data-options="width:900, height:506"><?php esc_html_e('Play Video', 'photography-translation' ); ?></a>
						<?php
						        break;
						        //end vimeo video
