...
//Register javascript
wp_register_script("photography-script-gallery-mixed-grid", admin_url('admin-ajax.php')."?action=photography_script_gallery_mixed_grid&id=portfolio_filter_wrapper&gutter=0&filter=".$filter."&next_action=photography_portfolio_mixed_grid&layout=contain&page_id=".$current_page_id, false, THEMEVERSION, true);
...
wp_enqueue_script("photography-script-gallery-mixed-grid", admin_url('admin-ajax.php')."?action=photography_script_gallery_mixed_grid&id=portfolio_filter_wrapper&gutter=0&filter=".$filter."&next_action=photography_portfolio_mixed_grid&layout=contain&page_id=".$current_page_id, false, THEMEVERSION, true);
?>
