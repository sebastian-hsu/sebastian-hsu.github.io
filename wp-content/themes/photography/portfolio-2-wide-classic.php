...
wp_register_script("photography-script-gallery-masonry", admin_url('admin-ajax.php')."?action=photography_script_gallery_masonry&id=portfolio_filter_wrapper&gutter=0&filter=".$filter."&next_action=photography_portfolio_classic&columns=2&type=grid&layout=wide&page_id=".$current_page_id, false, THEMEVERSION, true);
...
wp_enqueue_script("photography-script-gallery-masonry", admin_url('admin-ajax.php')."?action=photography_script_gallery_masonry&id=portfolio_filter_wrapper&gutter=0&filter=".$filter."&next_action=photography_portfolio_classic&columns=2&type=grid&layout=wide&page_id=".$current_page_id, false, THEMEVERSION, true);
?>
