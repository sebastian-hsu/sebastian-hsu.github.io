...
wp_enqueue_script("photography-script-gallery-masonry", admin_url('admin-ajax.php')."?action=photography_script_gallery_masonry&id=portfolio_filter_wrapper&gutter=".$gutter, false, THEMEVERSION, true);
...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="gallery <?php echo esc_attr($wrapper_class); ?> portfolio-content section content clearfix <?php echo esc_attr($gallery_wrapper_class); ?>" data-columns="<?php echo esc_attr($tg_gallery_proofing_columns); ?>">
			        ...
			        <div class="portfolio_classic_icon_wrapper">
					    <div class="portfolio_classic_icon_content">
					    	<div class="portfolio_classic_icon_content_middle">
						    	<a title="<?php esc_html_e('View', 'photography-translation' ); ?>" id="image<?php echo esc_attr($photo_id); ?>_image" <?php echo photography_get_lightbox_caption_attr($photo_id, false); ?> class="fancy-gallery tooltip" href="<?php echo esc_url($image_url[0]); ?>">
