...
wp_register_script("photography-script-gallery-masonry", admin_url('admin-ajax.php')."?action=photography_script_gallery_masonry&id=portfolio_filter_wrapper&gutter=30&filter=".$filter."&next_action=photography_portfolio_grid&columns=2&type=grid&layout=contain&page_id=".$current_page_id, false, THEMEVERSION, true);
...
wp_enqueue_script("photography-script-gallery-masonry", admin_url('admin-ajax.php')."?action=photography_script_gallery_masonry&id=portfolio_filter_wrapper&gutter=30&filter=".$filter."&next_action=photography_portfolio_grid&columns=2&type=grid&layout=contain&page_id=".$current_page_id, false, THEMEVERSION, true);
