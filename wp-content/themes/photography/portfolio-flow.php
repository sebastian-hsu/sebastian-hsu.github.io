...
if(empty($term))
{
	wp_enqueue_script("photography-script-flow-portfolio", admin_url('admin-ajax.php')."?action=photography_script_flow_portfolio", false, THEMEVERSION, true);
}
else
{
	wp_enqueue_script("photography-script-flow-portfolio", admin_url('admin-ajax.php')."?action=photography_script_flow_portfolio&portfolioset=".$term, false, THEMEVERSION, true);
}
?>
