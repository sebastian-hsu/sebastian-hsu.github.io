...
wp_register_script("photography-script-gallery-metro", admin_url('admin-ajax.php')."?action=photography_script_gallery_metro&id=portfolio_mixed_filter_wrapper&gutter=0&filter=".$filter."&next_action=photography_portfolio_metro&layout=wide&page_id=".$current_page_id, false, THEMEVERSION, true);
...
wp_enqueue_script("photography-script-gallery-metro", admin_url('admin-ajax.php')."?action=photography_script_gallery_metro&id=portfolio_mixed_filter_wrapper&gutter=0&filter=".$filter."&next_action=photography_portfolio_metro&layout=wide&page_id=".$current_page_id, false, THEMEVERSION, true);
?>
