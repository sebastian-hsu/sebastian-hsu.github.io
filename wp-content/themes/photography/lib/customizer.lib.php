...
function photography_custom_setting( $controls ) {
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Retina Logo in Theme Setting', 'photography-translation' ),
        'description' => esc_html__('Check this to replace theme setting to your logo. It helps branding your site', 'photography-translation' ),
        'section'  => 'logo_favicon',
        'default'  => '',
	    'priority' => 4,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Image Border Radius', 'photography-translation' ),
        'section'  => 'general_image',
        'default'  => 0,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Lazy Loading Progressive Image', 'photography-translation' ),
        'description' => esc_html__('Check this to enable loading a very small, blurred image is replaced with the full-resolution equivalent when the element is scrolled into view. After activating these setting you may need to regenerate your thumbnails', 'photography-translation' ),
        'section'  => 'general_image',
        'default'  => '',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Body and Content Settings', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Header Settings', 'photography-translation' ),
        'section'  => 'general_typography',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Text Transform', 'photography-translation' ),
        'section'  => 'general_typography',
        'default'  => 'uppercase',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Font Spacing', 'photography-translation' ),
        'section'  => 'general_typography',
        'default'  => 1,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Line Height', 'photography-translation' ),
        'section'  => 'general_typography',
        'default'  => 1.6,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Input and Textarea Settings', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Input and Textarea Border Radius', 'photography-translation' ),
        'section'  => 'general_input',
        'default'  => 0,
        'choices' => array( 'min' => 0, 'max' => 25, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Settings', 'photography-translation' ),
        'section'  => 'general_input',
	    'priority' => 19,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Border Radius', 'photography-translation' ),
        'section'  => 'general_input',
        'default'  => 0,
        'choices' => array( 'min' => 0, 'max' => 25, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Font Size', 'photography-translation' ),
        'section'  => 'general_input',
        'default'  => 13,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Font Weight', 'photography-translation' ),
        'section'  => 'general_input',
        'default'  => 600,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Font Spacing', 'photography-translation' ),
        'section'  => 'general_input',
        'default'  => 2,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Font Text Transform', 'photography-translation' ),
        'section'  => 'general_input',
        'default'  => 'uppercase',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Background Color', 'photography-translation' ),
        'section'  => 'general_boxed',
        'default'  => '#f0f0f0',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Background Image', 'photography-translation' ),
        'description' => esc_html__('Upload background image for boxed layout', 'photography-translation' ),
        'section'  => 'general_boxed',
	    'default'  => '',
	    'priority' => 28,
    );
	...
	$controls[] = array(
        ...
        'label'    => esc_html__('Menu Layout Settings', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Border for Transparent Menu', 'photography-translation' ),
        'description' => esc_html__('Enable this option to display border for transparent main menu', 'photography-translation' ),
        'section'  => 'menu_color',
        'default'  => 1,
	    'priority' => 7,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Transparent Menu Background Opacity', 'photography-translation' ),
        'section'  => 'menu_color',
        'default'  => 10,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Typography Settings', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Color Settings', 'photography-translation' ),
        'section'  => 'menu_submenu',
	    'priority' => 12,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Add Gradient Effect After Header Background Image', 'photography-translation' ),
        'description' => esc_html__('Enable this option to add gradient effect after header background image', 'photography-translation' ),
        'section'  => 'header_background',
        'default'  => 0,
	    'priority' => 18,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Alignment', 'photography-translation' ),
        'description' => esc_html__('Select alignment for page title', 'photography-translation' ),
        'section'  => 'header_title',
        'default'  => 'center',
        'choices'  => $tg_text_alignment,
        'output' => array(
	        array(
	            'element'  => '#page_caption .page_title_wrapper, #portfolio_wall_filters, .portfolio_wall_filters, .page_tagline, #page_caption.hasbg .page_tagline',
	            'property' => 'text-align',
	        ),
	    ),
	    'js_vars'   => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Header Width (%)', 'photography-translation' ),
        'section'  => 'header_title',
        'default'  => 100,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Line Height', 'photography-translation' ),
        'section'  => 'header_title',
        'default'  => 1.6,
        'choices' => array( 'min' => 0.5, 'max' => 3, 'step' => .1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Background Image Vertical Alignment', 'photography-translation' ),
        'section'  => 'header_title_bg',
        'default'  => 'baseline',
        'choices'  => array(
        	'baseline'	=> 'Baseline',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Background Image Font Size', 'photography-translation' ),
        'section'  => 'header_title_bg',
        'default'  => 22,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Background Image Overlay Opacity', 'photography-translation' ),
        'section'  => 'header_title_bg',
        'default'  => 70,
        'choices' => array( 'min' => 0, 'max' => 100, 'step' => 5 ),
	    'priority' => 9,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Tagline Alignment (With Background Image)', 'photography-translation' ),
        'section'  => 'header_title_bg',
        'default'  => 'side',
        'choices'  => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Content Builder Header Font Weight', 'photography-translation' ),
        'section'  => 'header_builder_title',
        'default'  => 400,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Content Builder Header Font Spacing', 'photography-translation' ),
        'section'  => 'header_builder_title',
        'default'  => 1,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Content Builder Header Line Height', 'photography-translation' ),
        'section'  => 'header_builder_title',
        'default'  => 1.6,
        'choices' => array( 'min' => 0.5, 'max' => 3, 'step' => .1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'output' => array(
	        array(
	            'element'  => '.page_tagline, .ppb_header_content',
	            'property' => 'font-style',
	        ),
	    ),
	    'js_vars'   => array(
    ...
    //Register Sidebar Tab Settings
     $controls[] = array(
        ...
        'label'    => esc_html__('Enable Sticky Sidebar', 'photography-translation' ),
        'description' => esc_html__('Check this to displays sidebar fixed when scrolling.', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Widget Title Alignment', 'photography-translation' ),
        'description' => esc_html__('Select alignment for widget title', 'photography-translation' ),
        'section'  => 'sidebar_typography',
        'default'  => 'center',
        'choices'  => $tg_text_alignment,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Sidebar Title Border Box', 'photography-translation' ),
        'section'  => 'sidebar_typography',
        'default'  => 1,
	    'priority' => 5,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Sidebar Padding Top', 'photography-translation' ),
        'section'  => 'footer_general',
        'default'  => 50,
        'choices' => array( 'min' => 0, 'max' => 200, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Sidebar Padding Bottom', 'photography-translation' ),
        'section'  => 'footer_general',
        'default'  => 50,
        'choices' => array( 'min' => 0, 'max' => 200, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Sidebar Color Settings', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Copyright Color Settings', 'photography-translation' ),
        'section'  => 'footer_color',
	    'priority' => 14,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Copyright Background Color', 'photography-translation' ),
        'section'  => 'footer_color',
        'default'  => '#ffffff',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Copyright Font Color', 'photography-translation' ),
        'section'  => 'footer_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('General Settings', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Gallery Thumbnails Hover Effect', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Gallery Featured Image as Header', 'photography-translation' ),
        'description' => esc_html__('Check this to display featured image as background header in single gallery page', 'photography-translation' ),
        'section'  => 'gallery_general',
        'default'  => 0,
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Gallery Proofing Settings', 'photography-translation' ),
        'section'  => 'gallery_general',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Client Gallery Settings', 'photography-translation' ),
        'section'  => 'gallery_general',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Client Gallery Layout', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Gallery Title Font Weight', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Gallery Title Font Spacing', 'photography-translation' ),
        'section'  => 'gallery_typography',
        'default'  => 1,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Gallery Title Font Text Transform', 'photography-translation' ),
        'section'  => 'gallery_typography',
        'default'  => 'uppercase',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable theme lightbox', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Lightbox Plugin', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Lightbox slideshow timer', 'photography-translation' ),
        'description' => esc_html__('Select number of seconds for lightbox slideshow timer', 'photography-translation' ),
        'section'  => 'gallery_lightbox',
        'default'  => 7,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('iLightbox Plugin Settings', 'photography-translation' ),
        'section'  => 'gallery_lightbox',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Select iLightbox thumbnails alignment', 'photography-translation' ),
        'description' => esc_html__('Select which alignment you want to use for iLightbox thumbnails', 'photography-translation' ),
        'section'  => 'gallery_lightbox',
        'default'  => 'horizontal',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('ModuloBox Plugin Settings', 'photography-translation' ),
        'section'  => 'gallery_lightbox',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Select ModuloBox thumbnails', 'photography-translation' ),
        'description' => esc_html__('Select if you want to display ModuloBox thumbnails', 'photography-translation' ),
        'section'  => 'gallery_lightbox',
        'default'  => 'thumbnail',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Gallery Archive Title Style', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display slideshow image info', 'photography-translation' ),
        'description' => esc_html__('Check this option if you want to display fullscreen slideshow image information', 'photography-translation' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 1,
	    'priority' => 7,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Image info display options', 'photography-translation' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 'caption',
        'choices'  => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Thumbnails Hover Effect', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Title Font Weight', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Title Font Spacing', 'photography-translation' ),
        'section'  => 'portfolio_typography',
        'default'  => 1,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Title Font Text Transform', 'photography-translation' ),
        'section'  => 'portfolio_typography',
        'default'  => 'uppercase',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Grid Tittle Style', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Full Blog Post Content on Blog Classic Layouts', 'photography-translation' ),
        'description' => esc_html__('Check this option to display post full content in blog classic pages', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Post Excerpt on Blog Grid Layouts', 'photography-translation' ),
        'description' => esc_html__('Check this option to display post excerpt in blog grid pages', 'photography-translation' ),
        'section'  => 'blog_general',
        'default'  => 1,
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('General Post Title Settings', 'photography-translation' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Post Title Font Weight', 'photography-translation' ),
        'section'  => 'blog_typography',
        'default'  => 400,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Post Title Font Spacing', 'photography-translation' ),
        'section'  => 'blog_typography',
        'default'  => 0,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Post Title Font Text Transform', 'photography-translation' ),
        'section'  => 'blog_typography',
        'default'  => 'uppercase',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Post Title Alignment', 'photography-translation' ),
        'description' => esc_html__('Select alignment for blog posts title', 'photography-translation' ),
        'section'  => 'blog_typography',
        'default'  => 'center',
        'choices'  => $tg_text_alignment,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Single Post Title Settings', 'photography-translation' ),
        'section'  => 'blog_typography',
	    'priority' => 4,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Single Post Title Font Size', 'photography-translation' ),
        'section'  => 'blog_typography',
        'default'  => 34,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Single Post Title Line Height', 'photography-translation' ),
        'section'  => 'blog_typography',
        'default'  => 1.6,
        'choices' => array( 'min' => 0.5, 'max' => 3, 'step' => .1 ),
        'output' => array(
	...
	if(class_exists('Woocommerce'))
	{
	    ...
	    $controls[] = array(
	        ...
	        'label'    => esc_html__('Product Title Font Weight', 'photography-translation' ),
	    ...
	    $controls[] = array(
	        ...
	        'label'    => esc_html__('Product Title Font Spacing', 'photography-translation' ),
	        'section'  => 'shop_typography',
	        'default'  => 1,
	        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
	        'output' => array(
	    ...
	    $controls[] = array(
	        ...
	        'label'    => esc_html__('Product Title Font Text Transform', 'photography-translation' ),
	        'section'  => 'shop_typography',
	        'default'  => 'uppercase',
	        'choices'  => $tg_text_transform,
	        'output' => array(
