		    	...
		    	<div id="logo_right_button">
					...
					<?php endif; ?>
						<div>
							...
							<button>
								<img style="max-width:13px;" src="<?php echo get_stylesheet_directory_uri(); ?>/images/search_gold.png" alt="">
							</button>
						</div>
			    	...
			    	<!-- Begin side menu -->
					<a href="javascript:;" id="mobile_nav_icon" title="mobile_nav_icon">&nbsp;</a>
					<!-- End side menu -->
