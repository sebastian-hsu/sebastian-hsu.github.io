<!-- Begin mobile menu -->
<a id="close_mobile_menu" href="javascript:;;" title="close_mobile_menu">&nbsp;</a>
...
<div class="mobile_menu_wrapper">
    <?php
	    ...
	    {
	?>
	<ul class="mobile_language_link">
					<?php echo do_shortcode('[ks_show_ml]');?>
					</ul>
	<?php
	    }
	?>
	...
	<form method="get" name="searchform" id="header_searchform" action="<?php echo get_option('siteurl'); ?>">
					<?php elseif (ICL_LANGUAGE_CODE == 'en'): ?>
					<form method="get" name="searchform" id="header_searchform" action="<?php echo get_option('siteurl'); ?>/en">
					<?php endif; ?>
	    <div><label for="s" style="display:none;">Search</label>
	    	<input type="text" value="<?php the_search_query(); ?>" name="s" id="s" autocomplete="off" placeholder=""/>
	    	<button>
	        	<img style="max-width:13px;" src="<?php echo get_stylesheet_directory_uri(); ?>/images/search_black.png" alt="">
	        </button>
	    </div>
