...
$cat = get_the_terms($post->ID,'gallerycat');
get_header();
...
<div class="inner">
					...
					<?php $url =  $cat[0]->slug=="gallery1"?"/photos/":"/dean-photos/";?>
				<a href="<?php echo $url;?>" class="back_page"  alt="返回上一頁"><</a>
					<!-- 英文 -->
					<?php elseif (ICL_LANGUAGE_CODE == 'en'): ?>
					 <?php $url =  $cat[0]->slug=="gallery1-en"?"/en/photos/":"/en/dean-photos/";?>
<a href="<?php echo $url;?>" class="back_page mxp <?php echo $cat[0]->slug;?>" alt="返回上一頁"><</a>
						<?php endif; ?>
