...
<div id="page_content_wrapper" class="<?php if(!empty($pp_page_bg)) { ?>hasbg<?php } ?> <?php if(!empty($pp_page_bg) && !empty($photography_topbar)) { ?>withtopbar<?php } ?>">
    <div class="inner">
    	<!-- Begin main content -->
    	<div class="inner_wrapper">
    		<div class="sidebar_content full_width talk_page">
					<div class="row">
						<?php if (ICL_LANGUAGE_CODE == 'zh-hant'): ?>
						<div class="col-md-3 talk_left">
							<!-- 院史-左側區塊 -->
							<?php echo do_shortcode('[content_block id=6213]');?>
						</div>
						<div class="col-md-9">
								<div class="talk_content"><?php echo do_shortcode('[content_block id=6228]');?></div>
							
						</div>
					<?php elseif (ICL_LANGUAGE_CODE == 'en'): ?>
							<div class="col-md-3 talk_left">
							<!-- 院史-左側區塊 -->
							<?php echo do_shortcode('[content_block id=6220]');?>
						</div>
						<div class="col-md-9">
							
									<div class="talk_content"><?php echo do_shortcode('[content_block id=6231]');?></div>
