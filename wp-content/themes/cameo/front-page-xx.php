			...
			<section class="wrap human active">
				...
				<div class="tab-panel">
					...
					<div class="tab active human01">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">歷史語言研究所</h3>
							...
							<div class="website">www2.ihp.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of History and Philology</h3>
					...
					<div class="tab human02">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">民族學研究所</h3>
							...
							<div class="website">www.ioe.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Ethnology</h3>
					...
					<div class="tab human03">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">近代史研究所</h3>
							...
							<div class="website">www.mh.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Modern History</h3>
					...
					<div class="tab human04">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">經濟研究所</h3>
							...
							<div class="website">www.econ.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Economics</h3>
					...
					<div class="tab human05">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">歐美研究所</h3>
							...
							<div class="website">www.ea.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of European and American Studies</h3>
					...
					<div class="tab human06">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">社會學研究所</h3>
							...
							<div class="website">www.ios.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Sociology</h3>
					...
					<div class="tab human07">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">中國文哲研究所</h3>
							...
							<div class="website">www.litphil.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Chinese Literature and Philosophy</h3>
					...
					<div class="tab human08">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">臺灣史研究所</h3>
							...
							<div class="website">www.ith.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Taiwan History</h3>
					...
					<div class="tab human09">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">語言學研究所</h3>
							...
							<div class="website">www.ling.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Linguistics</h3>
					...
					<div class="tab human10">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">法律學研究所</h3>
							<p class="content" lang="zh-Hant">2011年正式成立，以「（1）憲政體制與人權保障、（2）行政管制與行政爭訟、（3）科技發展與法律規範、（4）法律思想與社會變遷、（5）大陸與港澳法律發展、（6）司法制度、司法行為與立法學」六大重點研究領域為發展方向，期能為我國法學研究樹立典範，促進民主法治的實踐。現有研究人員約18名。</p>
							<div class="phone">886-2-2652-5400</div>
							<div class="website">www.iias.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institutum Iurisprudentiae</h3>
					...
					<div class="tab human11">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">政治學研究所</h3>
							...
							<div class="website">www.ipsas.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Political Science</h3>
					...
					<div class="tab human12">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">人文社會科學研究中心</h3>
							<p class="content" lang="zh-Hant">研究特色乃是跨領域研究，目前包含5個專題中心：政治思想研究專題中心、制度與行為研究專題中心、亞太區域研究專題中心、調查研究專題中心，及地理資訊科學研究專題中心。現有研究人員20名。</p>
							<div class="phone">886-2-2782-1693</div>
							<div class="website">www.rchss.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Research Center for Humanities and Social Sciences</h3>
							<p class="content" lang="en">The Research Center for Humanities and Social Sciences (RCHSS) is currently Academia Sinica’s only research center in the social sciences and humanities, fostering interdisciplinary research. The Center consists of five thematic research centers, including the Center for Political Thought, Center for Institution and Behavior Studies (CIBS), Center for Asia-Pacific Area Studies (CAPAS), Center for Survey Research (CSR) and Center for Geographic Information Science (GIS). There are 20 research fellows at this Center.</p>
							<div class="phone">886-2-2782-1693</div>
							<div class="website">www.rchss.sinica.edu.tw</div>
						</div>
					</div>
			...
			<section class="wrap life">
				...
				<div class="tab-panel">
					...
					<div class="tab active life01">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">植物暨微生物學研究所</h3>
							...
							<div class="website">ipmb.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Plant and Microbial Biology</h3>
					...
					<div class="tab life02">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">細胞與個體生物學研究所</h3>
							...
							<div class="website">www.icob.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Cellular and Organismic Biology</h3>
					...
					<div class="tab life03">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">生物化學研究所</h3>
							...
							<div class="website">www.ibc.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Biological Chemistry</h3>
							<p class="content" lang="en">The IBC's research covers four themes: Membrane protein structures and modifications, autophagy regulation and diseases,
								structural biology, and structure-based study of protein functions and drug discovery. The IBC laboratories are housed
								in two research facilities located on the Academia Sinica and National Taiwan University (NTU) main campuses. Over
								the years, the IBC has benefited from a long-term collaborative relationship with the NTU Institute of Biochemical
								Sciences in the sharing of teaching, research and resources. The Institute currently has a team of about 23 pearch
								fellows.</p>
							<div class="phone">886-2-2785-5696</div>
							<div class="website">www.ibc.sinica.edu.tw</div>
						</div>
					...
					<div class="tab life04">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">生物醫學科學研究所</h3>
							...
							<div class="website">www.ibms.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Biomedical Sciences</h3>
					...
					<div class="tab life05">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">分子生物研究所</h3>
							...
							<div class="phone">886-2-2789-9000</div>
							<div class="website">www.imb.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Molecular Biology</h3>
					...
					<div class="tab life06">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">基因體研究中心</h3>
							<p class="content" lang="zh-Hant">於2003年成立，近期積極針對國人重要疾病之防治，透過跨領域研究，發展高靈敏度的研究平台和儀器，分析人類疾病與微生物基因體、蛋白質體及醣體學結構與功能。主要研究課題如下：化學生物學研究、醫學生物學研究、物理與資訊基因體學研究。現有研究人員約24名。</p>
							<div class="phone">886-2-2789-9930</div>
							<div class="website">www.genomics.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Genomics Research Center</h3>
					...
					<div class="tab life07">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">生物多樣性研究中心</h3>
							...
							<div class="website">www.biodiv.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Biodiversity Research Center</h3>
					...
					<div class="tab life08">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">農業生物科技研究中心</h3>
							...
							<div class="website">abrc.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Agricultural Biotechnology Research Center</h3>
			...
			<section class="wrap math">
				...
				<div class="tab-panel">
					...
					<div class="tab active math01">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">數學研究所</h3>
							...
							<div class="website">www.math.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Mathematics</h3>
					...
					<div class="tab math02">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">物理研究所</h3>
							...
							<div class="website">www.phys.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Physics</h3>
							<p class="content" lang="en">For many years, the Institute of Physics, with its 44 faulty-level research fellows, has been pursuing cutting-edge research
								programs in three main directions: Medium and High Energy Physics, Physics of Active Biological Systems, and Quantum
								Materials Physics, covering subjects on Particle Physics and Cosmology, Nuclear Physics, Physics of Emergent Materials,
								Surface and NanoScience Laboratory, Biophysics, and Nonlinear and Fluid Dynamics. We strive to achieve excellence
								in basic and applied research and to nurture outstanding talents for the future.</p>
							<div class="phone">886-2-2788-0058</div>
							<div class="website">www.phys.sinica.edu.tw</div>
						</div>
					</div>
					<div class="tab math03">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">化學研究所</h3>
							...
							<div class="website">www.chem.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Chemistry</h3>
							<p class="content" lang="en">Reserachers at the Institute of Chemistry delve into the development of cutting-edge chemical technology and its practical
								applications in biomedicine and sustainable science. Currently there are 28 research fellows at the Institute. Research
								thrusts cover materials chemistry, chemical catalysis and synthesis, and chemical biology. Major topics include organic
								electronic materials, optoelectronic materials, green catalysis, synthetic methodology, disease mechanism, and chemical
								probes. </p>
							<div class="phone">886-2-2782-1889</div>
							<div class="website">www.chem.sinica.edu.tw</div>
						</div>
					...
					<div class="tab math04">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">地球科學研究所</h3>
							...
							<div class="website">www.earth.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Earth Sciences</h3>
					...
					<div class="tab math05">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">資訊科學研究所</h3>
							...
							<div class="website">www.iis.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Information Science</h3>
					...
					<div class="tab math06">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">統計科學研究所</h3>
							...
							<div class="website">www.stat.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Statistical Science</h3>
					...
					<div class="tab math07">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">原子與分子科學研究所</h3>
					...
					<div class="tab math08">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">天文及天文物理研究所</h3>
							...
							<div class="website">www.asiaa.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Institute of Astronomy and Astrophysics</h3>
					...
					<div class="tab math09">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">應用科學研究中心</h3>
							...
							<div class="website">www.rcas.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Research Center for Applied Sciences</h3>
					...
					<div class="tab math10">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">環境變遷研究中心</h3>
							...
							<div class="website">www.rcec.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Research Center for Environmental Changes</h3>
					...
					<div class="tab math11">
						<div class="cht">
							<h3 class="title" lang="zh-Hant">資訊科技創新研究中心</h3>
							...
							<div class="website">www.citi.sinica.edu.tw</div>
						</div>
						<div class="eng">
							<h3 class="title" lang="en">Research Center for Information Technology Innovation</h3>
